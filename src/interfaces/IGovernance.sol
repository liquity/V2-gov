...
interface IGovernance {
    ...
    event SnapshotVotes(uint256 votes, uint256 forEpoch);
    event SnapshotVotesForInitiative(address initiative, uint256 votes, uint256 forEpoch);

    event RegisterInitiative(address initiative, address registrant, uint256 atEpoch);
    event UnregisterInitiative(address initiative, uint256 atEpoch);

    event AllocateLQTY(address user, address initiative, int256 deltaVoteLQTY, int256 deltaVetoLQTY, uint256 atEpoch);
    ...
    struct Configuration {
        ...
        uint256 registrationWarmUpPeriod;
